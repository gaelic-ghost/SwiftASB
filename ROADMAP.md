...
3. Decide how `RecentFiles` should evolve around selection-aware payload retention, shell-versus-payload slimming, and any future relationship to a mixed `RecentActivity` timeline.

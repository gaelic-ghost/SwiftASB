...
2. Continue promoting app-server-owned workspace and Git facts beyond the
   current cwd and origin metadata: Git worktree root if upstream exposes it,
   branch/SHA observables, sandbox/permission provenance, and any workspace

...
9. Expand DocC before v1: keep the first `SwiftASB.docc` catalog current, add deeper symbol comments where the generated documentation is too terse, add more copy-pasteable walkthroughs, and validate the catalog through the package documentation generation path.
...
- [ ] Expand DocC with deeper source-level symbol comments, more examples, and documentation-generation validation before a v1 tag.

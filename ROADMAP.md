...
5. Decide whether `RecentActivity` should exist as a first-class mixed feed now that separate recent-turn, recent-file, and recent-command companions all exist.

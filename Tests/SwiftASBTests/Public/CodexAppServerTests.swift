...
struct CodexAppServerTests {
    ...
    func surfacesCodexCLIDiagnosticsAfterStart() async throws {
        let transport = FakeCodexAppServerTransport(
            executableResolution: .init(
                ...
                versionString: "codex-cli 0.126.0",
                compatibility: .supported(documentedWindow: "0.126.x through 0.128.x")
            )
        )
        let client = CodexAppServer(transport: transport)
        ...
        #expect(diagnostics.versionString == "codex-cli 0.126.0")
        #expect(diagnostics.compatibility == .supported(documentedWindow: "0.126.x through 0.128.x"))
    ...
    func runsInitializeAndFirstLifecycleRequests() async throws {
        ...
        #expect(initializeSession.userAgent == "codex-cli/0.126.0")

...
| App-list and skills-change notifications | `CodexAppServer.Inventory` and Library app snapshots | `Observable-only for app-snapshot refresh`: raw notifications trigger refreshed app-wide mirrors instead of becoming public event cases. |
